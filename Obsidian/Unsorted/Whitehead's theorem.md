...
**Full Statement**: If $(X, x_0) \xrightarrow{f} (Y, f(x_0))$ such that the induced maps `
<span class="math display">
\begin{align*}
f_*: \pi_*(X, x_0) \to \pi_*(Y, y_0) \\
 [g] \mapsto [f \circ g]
\end{align*}
<span>`{=html} are all isomorphisms and $Y$ is connected, then $f$ is a homotopy equivalence.
