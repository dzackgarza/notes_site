...
-   Kervaire and Milnor reduced Question 1.5 to a computation of the stable homotopy groups of spheres. In fact, Kervaire and Milnor constructed the $\Theta_n \in {\mathsf{Grp}}$ of [homotopy spheres](homotopy%20spheres). This classifies \[\[smooth structures\]\] on $S^n$ for $n\geq 5$.
...
-   The \[\[K3 Surfaces\]\] plays an important role in the third stable homotopy group of spheres.
    -   It can be viewed as the source of the \[\[24\]\] in the group $\pi_3 {\mathbb{S}}= {\mathbb{Z}}/{24}$.
...
-   It is well-known that the complex \[\[Hopf map\]\] $\eta: S^3 \to S^2$ suspends to a generator of $\pi_4(S^3] = \pi_1 {\mathbb{S}}= {\mathbb{Z}}_2$.
...
-   \[\[J-homomorphism\]\] The stable homotopy groups (in degree $n$) of spheres are the same as \[\[of dimension $n$\](stable framing\]\] manifolds (of dimension $n$).
...
The subgroup $\operatorname{bP}_{n+1}$ is analyzed via \[\[surgery\]\] and the \[\[h-cobordism theorem\]\]. There's a nice summary in Lück's Basic introduction to surgery theory.
...
Finally, $\operatorname{bP}_{4p+2}$ is at most $Z_2$. Here $S$ bounds a \[\[Kervaire invariant one\]\].
