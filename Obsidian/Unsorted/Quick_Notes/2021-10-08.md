...
\nopagecolor
\begin{tikzcd}
    {p_1^* \tilde E} && {\tilde E \coloneqq Y\times {\mathbb{R}}^n} & {p_2^* \tilde E} \\
    \\
    {Y{ {}^{ \scriptscriptstyle{ \underset{\scriptscriptstyle {X} }{\times} }^{2} }  }} && {Y \coloneqq\displaystyle\coprod_i U_i} & {Y{ {}^{ \scriptscriptstyle{ \underset{\scriptscriptstyle {X} }{\times} }^{2} }  }} \\
    \\
    Y && {X = \displaystyle\bigcup_i U_i} & Y
