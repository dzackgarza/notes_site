...
\nopagecolor
\begin{tikzcd}
    {\lim_n X_n \cong {\operatorname{pt}}} && X && {\lim_n X_n \cong X} \\
    \vdots && \vdots && \vdots \\
    {X^2 = {\operatorname{hofib}}(f_2)} && X && {X_2 = \tau_{\leq 2} X} \\
    {X^1 = {\operatorname{hofib}}(f_1)} && X && {X_1 = \tau_{\leq 1} X} \\
    {X^0 = {\operatorname{hofib}}(0)} && X && {X_0 = {\operatorname{pt}}}
