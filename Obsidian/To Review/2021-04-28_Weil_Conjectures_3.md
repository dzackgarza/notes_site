...
Recall that we can write the [../Unsorted/Riemann zeta function](../Unsorted/Riemann%20zeta%20function.md) as the [Dirichlet series](../Unsorted/Dirichlet%20series.md) $\zeta(s) = \sum_n {1 \over n^s}$ and expand as an [Euler product](Euler%20product) $\prod_{p\text{ prime}} {1 \over 1 - p^{-s}$.
